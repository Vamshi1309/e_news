...
import 'package:e_news/secure_storage.dart';
import 'package:e_news/head_lines.dart';
      ...
      child: Scaffold(
                ...
                : CustomScrollView(
                    ...
                    slivers: [
                      SliverAppBar(
                        ...
                        expandedHeight: 80, // You can adjust this if needed
                        ...
                        SliverPadding(
                          ...
                          sliver: SliverList(
                            delegate: SliverChildBuilderDelegate(
                                childCount: filteredNews.length + 1,
                                (context, index) {
          ...
          drawer: Drawer(
            ...
            child: Column(
              ...
              children: [
                // Top section: profile emoji + name
                FutureBuilder<String?>(
                  future: SecureStorage().readName("name"),
                  builder: (context, snapshot) {
                    return Padding(
                      padding: const EdgeInsets.symmetric(
                          vertical: 40.0, horizontal: 12),
                      child: Row(
                        children: [
                          const CircleAvatar(
                            radius: 20,
